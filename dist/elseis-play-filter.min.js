!function () {
    ...
    function e(e, t, l) {
        function r() {
            ...
            t = e.all(g.currentSearchfilter), t.getList().then(function (e) {
                g.plays.length != e.data.length && (g.plays = e.data), a(e);
            });
        }
        function a(e) {
        ...
        var g = this;
        g.handleClickOnLetter = s, g.letterIsSelected = d, g.toggleDropdown = m, g.selectDropdownOption = y, g.loadAllPlays = r, g.loadAllAuthors = u, g.handleAuthorSelection = f, g.loadPlaysFilteredByKW = o, g.loadWithoutPagination = i, g.$onInit = function () {
            g.loadAllPlays(), g.loadAllAuthors();
        }, g.plays = [], g.allPages = !1, g.currentSearchfilter = 'obras-api/?', g.kwInput = '';
        var w = function () {
                var e = 0;
                return function (t, l) {
        ...
        g.selectedLetter = '', g.abecedario = ["a","b","c","d","e","f","g","h","i","j","k","l","m","n","ñ","o","p","q","r","s","t","u","v","w","x","y","z"], g.displayedAuthors = [], g.authors = [], g.selectedAuthor = '', g.dropdownVisible = !1, g.dropdownOptions = ["más actuales","más visitas","mejor valoradas","próximamente"], g.selectedDropdownOption = 'm\xE1s actuales';
    }
    ...
    function e() {
        ...
        e.$onInit = function () {
            ...
            e.localPlays = angular.copy(e.plays);
        }, e.localSelectedAuthor = void 0, e.localCategoryFilter = void 0;
    }
