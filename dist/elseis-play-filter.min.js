!function () {
    ...
    function e(e, t, l) {
        function r() {
            g.loading = !0, g.totalPages = 0, g.firstAllPages || (g.allPages = !1), a();
            var t;
            t = e.all(g.currentSearchfilter), t.getList().then(function (e) {
                g.plays = e.data, i(e), l(function () {
                    g.loading = !1;
                }, 500), g.firstAllPages = !1;
            });
        }
        function i(e) {
        ...
        function n() {
            g.allPages = !0, g.firstAllPages = !0, g.loadAllPlays();
        }
        function a() {
        ...
        var g = this;
        g.handleClickOnLetter = s, g.letterIsSelected = p, g.toggleDropdown = y, g.selectDropdownOption = m, g.loadAllPlays = r, g.loadAllAuthors = u, g.handleAuthorSelection = f, g.loadPlaysFilteredByKW = o, g.loadWithoutPagination = n, g.$onInit = function () {
        ...
        g.selectedLetter = '', g.abecedario = ["a","b","c","d","e","f","g","h","i","j","k","l","m","n","ñ","o","p","q","r","s","t","u","v","w","x","y","z"], g.displayedAuthors = [], g.authors = [], g.selectedAuthor = '', g.dropdownVisible = !1, g.dropdownOptions = ["más actuales","más visitas","mejor valoradas","próximamente"], g.selectedDropdownOption = 'm\xE1s visitas';
    }
    ...
    function e() {
        ...
        var r = this;
        r.$onInit = function () {
        }, r.$onChanges = function (i) {
            r.localPlays = angular.copy(r.plays), t(), l(), e(i);
