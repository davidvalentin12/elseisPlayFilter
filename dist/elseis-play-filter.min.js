!function () {
    ...
    function e(e) {
        ...
        }, d.plays = [], d.currentSearchfilter = 'obras-api/?', d.kwInput = '', d.selectedLetter = '', d.abecedario = ["a","b","c","d","e","f","g","h","i","j","k","l","m","n","ñ","o","p","q","r","s","t","u","v","w","x","y","z"], d.displayedAuthors = [], d.authors = [], d.selectedAuthor = '', d.dropdownVisible = !1, d.dropdownOptions = ["más actuales","más visitas","mejor valoradas","próximamente"], d.selectedDropdownOption = 'm\xE1s actuales';
    }
